...
- **浮动流排版**
    ...
    **<br><br>  浮动流注意:**
<br>(1)浮动流中没有居中对齐, **只有 none left right 3个取值**<br>(2)在浮动流中是 **不能使用 margin:0px auto; 这种方式来让子元素在父元素中水平居中的**
    **<br><br> 浮动流特点:**<br>(1) 在浮动流中是 不区分 块级元素 \ 行内元素 \ 行内块级元素的, **都可以水平排版的**<br>(2) 在浮动流无论是 块级元素 \ 行内元素 \ 行内块级元素 **都可以设置 宽高**.<br>(3) 综上所述, 浮动流中的元素和标准流中的 **行内块级元素很像.**,既可以水平排版又可以设置宽高
